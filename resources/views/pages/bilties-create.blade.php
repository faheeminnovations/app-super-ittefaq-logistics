  ...
  <div class="page-wrap">
    <div class="page-head">
      <div>
        ...
        <h1>Create New Bilty</h1>
        <div class="sub">Create traditional goods transportation receipt (بِلٹی)</div>
      </div>
    ...
    <div class="panel">
      <form action="{{ route('bilties.store') }}" method="POST">
        ...
        <div class="d-flex gap-2">
          <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i> Create Bilty</button>
          <a href="{{ route('bilties.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
      </form>
    </div>
