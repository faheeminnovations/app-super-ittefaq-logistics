  ...
  <div class="page-wrap">
    <div class="page-head">
      <div>
        ...
        <h1>Supply Chain Billing</h1>
        <div class="sub">سپلائی چین - Supply Chain Management</div>
      </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add Supply Chain Billing Record</h5>
          ...
          <form id="billingForm">
            <div class="row g-3">
              ...
              <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="load_id" placeholder="L-001">
              </div>
              <div class="col-md-2">
                <label class="form-label">Gate Pass #</label>
                <input type="text" class="form-control" id="gate_pass_number" placeholder="GP-001">
              </div>
              <div class="col-md-4">
  ...
  <script>
    ...
    function saveBilling() {
      ...
      const formData = {
        ...
        load_id: document.getElementById('load_id').value || null,
      ...
      fetch('/professional-billing/supply-chain/store', {
        method: 'POST',
        headers: {
    ...
    function deleteBilling(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch(`/professional-billing/supply-chain/${id}`, {
            method: 'DELETE',
            headers: {
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
            }
    ...
    function filterBillings() {
      ...
      window.location.href = `/professional-billing/supply-chain?month=${month}`;
    }
  </script>
@endsection
