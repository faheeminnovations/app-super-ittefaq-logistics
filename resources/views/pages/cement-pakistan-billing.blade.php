...
@section('content')
  <div class="page-wrap">
    <div class="page-head">
      <div>
        ...
        <h1>Syngenta Billing</h1>
        <div class="sub">سینجینٹا - Syngenta Management</div>
      </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add Syngenta Billing Record</h5>
  ...
  <script>
    ...
    function saveBilling() {
      ...
      fetch('/professional-billing/cement-pakistan/store', {
        method: 'POST',
        headers: {
    ...
    function deleteBilling(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch(`/professional-billing/cement-pakistan/${id}`, {
            method: 'DELETE',
            headers: {
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
            }
    ...
    function filterBillings() {
      ...
      window.location.href = `/professional-billing/cement-pakistan?month=${month}`;
    }
  </script>
@endsection
